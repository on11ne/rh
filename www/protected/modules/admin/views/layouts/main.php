        ...
        <div class="top-menus">
            ...
            <?php $this->widget('zii.widgets.CMenu',array(
                'items'=>array(
                    ...
                    array('label'=>'Продукты', 'url'=>array('product/admin')),
                    array('label'=>'Активации чеков', 'url'=>array('cheque/admin')),
                    array('label'=>'Обратная связь', 'url'=>array('feedback/admin')),
                    array('label'=>'Выйти ('.Yii::app()->user->name.')', 'url'=>array('/site/logout'))
                ),
            )); ?>
